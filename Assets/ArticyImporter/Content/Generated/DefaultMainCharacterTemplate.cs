...
namespace Articy.World_Of_Red_Moon
{
    ...
    public class DefaultMainCharacterTemplate : Entity, IEntity, IPropertyProvider, IObjectWithFeatureElevenlabsVoiceLibrary, IObjectWithFeatureCharacterCard, IObjectWithFeatureDefaultExtendedCharacterFeature, IObjectWithFeatureDefaultBasicCharacterFeature
    {
        ...
        public ElevenlabsVoiceLibraryFeature GetFeatureElevenlabsVoiceLibrary()
        {
            return Template.ElevenlabsVoiceLibrary;
        }
